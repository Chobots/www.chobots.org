        ...
        __wbg_new_typed_c072c4ce9a2a0cdf: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_11372(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
...
function __wasm_bindgen_func_elem_11369(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_11369(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_11372(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_11372(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
