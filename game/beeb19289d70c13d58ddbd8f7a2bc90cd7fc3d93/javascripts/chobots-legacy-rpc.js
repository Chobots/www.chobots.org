(function (root, factory) {
    ...
    function RpcSession(callTimeoutMs, transport) {
    ...
    RpcSession.prototype.close = function (reason) {
        ...
        if (!this.disconnectCalled) {
            ...
            this.transport.disconnect(reason || "client_disconnect");
        }
    ...
    function connect(url, options) {
        ...
        var transport = options && options.transport || {
            observe: root.chobotsObserveWs,
            connect: root.chobotsWsConnect,
            send: root.chobotsWsSend,
            disconnect: root.chobotsWsDisconnect
        };
        if (!transport || typeof transport.observe !== "function"
        ...
        var session = new RpcSession(timeoutMs(options), transport);
        ...
        return new Promise(function (resolve, reject) {
            ...
            session.unsubscribe = transport.observe(function (event) {
